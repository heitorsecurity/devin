...
openHtml : function(aHtml){
    ...
    aHtml.push('<input type="checkbox" id="', this._sControlId, '"', (!this.isEnabled() ? ' disabled="disabled" tabindex="-1"' : '') ,'><label class="WebCheckbox_Caption" for="', this._sControlId, '"></label><div style="clear: both"></div>'); 
},
