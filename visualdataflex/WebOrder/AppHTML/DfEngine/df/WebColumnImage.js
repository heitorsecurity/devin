                ...
                if(aImages[i]){
                    if(this.pbImageByCSS){
                        ...
                        if(this.piImageWidth === 0 || this.piImageHeight === 0){
                            ...
                            aHtml.push('<span style="', sStyle, 'background-repeat: no-repeat; background-image: url(\'', aImages[i], '\');" data-dfimg="', aImages[i], '" style=""></span>');
                        }
                    }
                }
            }
        }else{
            aHtml.push('<span style="', sStyle, '" class="', aImages[i], '"></span>');
        }
    }else{
        if(this.pbImageByCSS){
